...
end, vim.tbl_extend("force", opts, { desc = "Go: Git with file search" }))

-- Telescope bindings
map("n", "gof", "<cmd>Telescope find_files<cr>", vim.tbl_extend("force", opts, { desc = "Go: Find files" }))
map("n", "got", "<cmd>Telescope live_grep<cr>", vim.tbl_extend("force", opts, { desc = "Go: Grep text" }))
map("n", "goh", "<cmd>Telescope help_tags<cr>", vim.tbl_extend("force", opts, { desc = "Go: Help tags" }))
map("n", "goo", "<cmd>Telescope oldfiles<cr>", vim.tbl_extend("force", opts, { desc = "Go: Recent files" }))
...
-- LSP shortcuts
map("n", "gos", "<cmd>lua vim.lsp.buf.definition()<cr>", vim.tbl_extend("force", opts, { desc = "Go to definition" }))
map("n", "god", "<cmd>lua vim.lsp.buf.declaration()<cr>", vim.tbl_extend("force", opts, { desc = "Go to declaration" }))
map("n", "gor", "<cmd>lua vim.lsp.buf.references()<cr>", vim.tbl_extend("force", opts, { desc = "Go to references" }))
map(
	"n",
	"gi",
